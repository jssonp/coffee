<template>
    <div class="main">
        ...
        <van-tabbar v-model="activeIndex" active-color="#9C623A" inactive-color="#646566"
        route>
            <van-tabbar-item v-for="(item, index) in tabbarData" :key="index" 
            :badge="item.badge >0 ? item.badge : ''" :dot="item.dot" :to="item.to">
