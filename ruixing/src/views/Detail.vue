<template>
    <div class="detail">
        ...
        <div>
                ...
                <div class="rules">
                    <div class="rule" v-for="(v1,i1) in detailData.rulesData" :key="i1">
                        ...
                        <div class="rule-items">
                            <div :class="{active: v1.currentIndex ===i2}" v-for="(v2,i2) in v1.rule" 
                            :key="i2" @click="selectRule(v1, i2)">{{v2.title}}</div>
                        </div>
                    </div>
            ...
            <van-goods-action>
                <van-goods-action-icon icon="bag" text="购物袋" color="#666" 
                :badge="shopbagCount > 0 ? shopbagCount: ''" @click="goShopbag" />
                <van-goods-action-icon icon="like" 
                :text="likeStatus ? '已收藏':'收藏'" 
                :color="likeStatus ? '#9C623A' : '#666'" 
                @click="likeAndNotLike" />
                <van-goods-action-button color="#E1964B" type="warning" text="加入购物带" 
                @click="goShopbag" />
                <van-goods-action-button color="#9C623A" type="danger" 
                text="立即购买" @click="buyNow" />
            </van-goods-action>
        </div>
    </div>
</template>
        ...
        methods: {
            ...
            getShopbagCount(isBuy) {
                ...
                this.axios({
                    ...
                    console.log('res getShopbagCount==> ', res);
                    this.$toast.clear();
