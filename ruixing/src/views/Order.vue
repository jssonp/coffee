<template>
    <div class="order">
        ...
        <Bg>
            <van-tabs v-model="activeTabIndex" swipeable :line-height="2" color="#9C623A" 
            title-active-color="#9C623A" title-inactive-color="#666" @change="changeOrderStatus">
                                    ...
                                    <template #pay-title>
                                        <div class="pay-title-box">
                                            ...
                                            <div class="pay-s" v-if="v1.status ===1">
                                                <div class="pay-text" @click="confirmOrder(v1,i1)">确认收货</div>
                                            </div>
                                        </div>
                                    </template>
                                    <template #order-item>
                                        <OrderItem v-for="(v2,i2) in v1.data" 
                                        :key="i2" :product="v2"></OrderItem>
                                    </template>
                                </PayBox>
                            </div>
                        </div>
